...
import { Facebook, Instagram, Mail, MapPin, Phone, FileText, X, Clock, VolumeX, Ban, CheckCircle } from 'lucide-react';
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div>
              ...
              <button 
                ...
                className="flex items-center gap-2 text-[#2EC4B6] hover:text-white transition-colors text-sm font-medium group"
              >
